...
//		}
    	...
    	$("#head_login").click(function(){
    		window.location.href=DOMAIN+"/AuctionLogin/toLoginPage?formUrl=/";
		});
    	$("#head_org_login").click(function(){
    		window.location.href=DOMAIN+"/organization/loginController/toOrgLoginPage";
    	});
    	$("#head_sign").click(function(){
    		window.location.href=DOMAIN+"/AuctionLogin/toRegisterPage";
		});
});
